...
public class ChatDisplay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Picasso.get().load(profilepic).placeholder(R.drawable.profile).into(binding.proImg);
        ...
        binding.send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(binding.messageType.getText().toString().isEmpty()){
                    binding.messageType.setError("empty message");
                    return;
                }
